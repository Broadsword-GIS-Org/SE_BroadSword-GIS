	...
	\end{itemize}
		...
		\begin{table}[h!]	
			...
			\begin{tabular}{|c|c|c|c|}
				...
				getAllBuildings  & \parbox[t]{\longline}{This function returns a list of all the buildings in the GIS database} & 7 & \parbox[t]{\longline}{Apply additional error handling \\ Function very reliable}\\
				...
				\hline
				getLectureCoordinates & \parbox[t]{\longline}{This function returns the coordinates of a lecture hall} & 8 & \parbox[t]{\longline}{Add Additional error handling to test whether the room exists or if not room was specified}\\
				\hline
				getBuildingCoordinates & \parbox[t]{\longline}{This function returns the coordinates of a specified bulding} &  7 & \parbox[t]{\longline}{Add Additional error handling to test for invalid or non-existent building names before executing a query}\\
				\hline
				getBuildingInRadius & \parbox[t]{\longline}{Gets building coordinates for all buildings in a specified radius} & 10 & \parbox[t]{\longline}{comment}\\
				\hline
